...
{
    /// <summary>
    ///     All functionality needed to convert models of type <typeparamref name="TModel" />  to data transfer objects
    ///     of type <typeparamref name="TDto" /> and vice versa.
    /// </summary>
    ...
    ///     </para>
    /// </remarks>
    public interface IBiDirectionalPersistentObjectMapper<TModel, TIdentity, TDto, in TContext>
        : IBiDirectionalComponentMapper<TModel, TDto, TContext>,
          IToDtoPersistentObjectMapper<TModel, TIdentity, TDto, TContext>,
          IToModelPersistentObjectMapper<TModel, TIdentity, TDto, TContext>
