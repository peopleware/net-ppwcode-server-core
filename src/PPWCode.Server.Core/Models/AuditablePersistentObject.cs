...
{
    /// <inheritdoc cref="IAuditablePersistentObject" />
    [DataContract(IsReference = true)]
    public abstract class AuditablePersistentObject
        : AuditablePersistentObject<long>,
          IAuditablePersistentObject,
          IEquatable<AuditablePersistentObject>
    {
        private int? _oldHashCode;

        protected AuditablePersistentObject(long id)
            : base(id)
        {
        }
        ...
        /// <inheritdoc />
        public virtual bool Equals(AuditablePersistentObject other)
            => IsSame(other);

        public override bool Equals(object obj)
            => IsSame(obj as AuditablePersistentObject);
        ...
        public static bool operator ==(AuditablePersistentObject x, AuditablePersistentObject y)
            => Equals(x, y);
    ...
    public abstract class AuditablePersistentObjectMapper<T> : AuditablePersistentObjectMapper<T, long>
        where T : AuditablePersistentObject
    {
